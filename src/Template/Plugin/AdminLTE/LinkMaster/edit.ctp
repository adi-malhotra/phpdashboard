...
<div class="linkMaster form large-9 medium-8 columns content">
  <div class="box" style = "margin-left:-12px;margin-right:-12px;">
    <div class="box-header with-border">
      <h3 class="box-title">Edit Link <?= $linkMaster->id ?></h3>
    </div>
    ...
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <?= $this->Form->text("link_url",["default"=>$linkMaster->link_url]) ?>
        </div>
      </div>
      <br>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <?= $this->Form->text("link_name",["default"=>$linkMaster->link_name]) ?>
        </div>
      </div>
      <br>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <?= $this->Form->select("application_id",$applications,["default"=>$linkMaster->application_id]) ?>
        </div>
      </div>
      <br>
      <div class="form-group">

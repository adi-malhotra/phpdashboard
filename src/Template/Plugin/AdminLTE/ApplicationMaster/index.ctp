...
<div class="applicationMaster index large-9 medium-8 columns content">
  <div class="box">
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th style = "text-align:center"><?= $this->Paginator->sort('description') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align = "center"><?= h($applicationMaster->description) ?></td>
    ...
    <div class="paginator">
        ...
        <div class="btn btn-block btn-primary" style = "background: white; font-size:1.2em; margin: auto; width:85%;"><?= $this->Html->link(__('New Application Master'), ['controller'=>'ApplicationMaster','action' => 'add']) ?></div><br>
